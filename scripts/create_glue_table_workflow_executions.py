#!/usr/bin/env python3
"""
Script to create the workflow_executions Glue table in AWS Athena.

This script reads the SQL DDL from infrastructure/glue_tables/workflow_executions.sql
...
SQL_FILE_PATH = "infrastructure/glue_tables/workflow_executions.sql"
...
def create_glue_table():
    """Main function to create the workflow_executions Glue table."""
    print("=" * 60)
    print("Creating workflow_executions Glue Table")
    print("=" * 60)
    ...
    try:
        ...
        if status == 'SUCCEEDED':
            ...
            print(f"   Table: {ATHENA_DATABASE}.workflow_executions")
            print(f"   Location: s3://brand-generator-rwrd-023-eu-west-1/workflow-executions/")
...
if __name__ == "__main__":
    print("\nGenerating Glue Table: workflow_executions")
