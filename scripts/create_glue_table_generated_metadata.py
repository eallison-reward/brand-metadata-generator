#!/usr/bin/env python3
"""
Script to create the generated_metadata Glue table in AWS Athena.

This script reads the SQL DDL from infrastructure/glue_tables/generated_metadata.sql
...
SQL_FILE_PATH = "infrastructure/glue_tables/generated_metadata.sql"
...
def create_glue_table():
    """Main function to create the generated_metadata Glue table."""
    print("=" * 60)
    print("Creating generated_metadata Glue Table")
    print("=" * 60)
    ...
    try:
        ...
        if status == 'SUCCEEDED':
            ...
            print(f"   Table: {ATHENA_DATABASE}.generated_metadata")
            print(f"   Location: s3://brand-generator-rwrd-023-eu-west-1/metadata/")
...
if __name__ == "__main__":
    print("\nGenerating Glue Table: generated_metadata")
