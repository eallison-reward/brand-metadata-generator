#!/usr/bin/env python3
"""
Script to create the feedback_history Glue table in AWS Athena.

This script reads the SQL DDL from infrastructure/glue_tables/feedback_history.sql
...
SQL_FILE_PATH = "infrastructure/glue_tables/feedback_history.sql"
...
def create_glue_table():
    """Main function to create the feedback_history Glue table."""
    print("=" * 60)
    print("Creating feedback_history Glue Table")
    print("=" * 60)
    ...
    try:
        ...
        if status == 'SUCCEEDED':
            ...
            print(f"   Table: {ATHENA_DATABASE}.feedback_history")
            print(f"   Location: s3://brand-generator-rwrd-023-eu-west-1/feedback/")
...
if __name__ == "__main__":
    print("\nGenerating Glue Table: feedback_history")
